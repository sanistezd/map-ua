  ...
  return (
    <Card className="mb-6 border-amber-200 bg-amber-50 dark:border-amber-900/50 dark:bg-amber-950/20">
      <CardHeader className="pb-3">
        <CardTitle className="text-amber-800 dark:text-amber-400">Anonymous Session</CardTitle>
        <CardDescription className="text-amber-700 dark:text-amber-500">
          You are currently logged in anonymously. If you log out or clear your browser data, your progress will be lost.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Button 
